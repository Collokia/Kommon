...
public class CorrectUrlDecoding {
    ...
    public static String decodePath(String path) throws URISyntaxException {
    ...
    public static String decodeQuery(String query) throws URISyntaxException {
        return decodeQuery(query, "UTF-8");
    }
    ...
    protected static String decodeURLEncoded(String part, boolean query, String charset) throws URISyntaxException{
        try{
